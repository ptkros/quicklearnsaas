$(document).ready(function() {
	...
	var pie;
	var sPieChartUrl = url+'/dv/testing/sessions/pie';
	var sPieChartData;
	...
	var d1_1;
	var d1_2;
	var sBarsChartUrl = url+'/dv/testing/sessions/bars';
	...
	var sDatatablesUrl = url+'/dv/testing/sessions/datatables';  
	...
	$('#dataTables-sessions tbody').on( 'click', 'tr', function () {
		...
		if ( tr.hasClass('info') ) {
    		...
    		var d = row.data();
    		var sName = d.name;
    		var urlSession = url+'/static/pages/test-session-details.html?session_name='+sName;
